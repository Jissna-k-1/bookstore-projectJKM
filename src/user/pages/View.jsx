        ...
        <div className="shadow border p-5 border-gray-300">
          <div className="md:grid grid-cols-4 gap-x-10">
            ...
            <div className="col-span-1">
              <img className='w-full' src="https://m.media-amazon.com/images/I/81C2QnortLL.jpg" alt="book" />
            </div>
            {/* book details col */}
            <div className="col-span-3">
              ...
              <div className="flex justify-end">
                <Link to={'/books'} className='bg-blue-700 rounded p-2 text-white flex items-center'><FaBackward className='me-2'/>Back</Link>
          ...
          <div className="flex justify-center items-center min-h-screen">
            <div className="bg-white rounded-2xl md:w-250 w-100">
              ...
              <div className="relative p-5">
                <p className='text-blue-600 flex items-center'style={{fontFamily:'cursive'}}><FaCamera className='me-2'/>Camera clicks of the book in the hand of seller</p>
                {/* book images in row */}
                <div className="md:flex flex-wrap my-4">
                  <img className='md:w-75 w-50 md:me-2 mb-3 md:mb-0' src="https://m.media-amazon.com/images/I/81C2QnortLL.jpg" alt="book" />                
                </div>
              </div>
            </div>
          </div>
