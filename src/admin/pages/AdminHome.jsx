      ...
      <div className='md:grid grid-cols-5'>
        ...
        <div className="col-span-4 p-10">
          ...
          <div className="md:grid grid-cols-4 gap-10">
            ...
            {/* block */}
            <div className="md:px-5 my-5 md:my-0">
              <div className="bg-yellow-100 p-4 flex justify-center items-center rounded">
                {/* icon */}
            ...
            {/* block */}
            <div className="md:px-5 my-5 md:my-0">
              <div className="bg-green-100 p-4 flex justify-center items-center rounded">
                {/* icon */}
              ...
              {/* block */}
            <div className="md:px-5 my-5 md:my-0">
              <div className="bg-red-100 p-4 flex justify-center items-center rounded">
                {/* icon */}
          ...
          {/* chart title */}
          <div className=" mt-10 md:grid grid-cols-2">
